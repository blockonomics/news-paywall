"""
Django settings for NewsPayWall project.
...
WSGI_APPLICATION = 'NewsPayWall.wsgi.application'
...
AUTHENTICATION_BACKENDS = ['authentication.CustomBackend.CustomBackend']
